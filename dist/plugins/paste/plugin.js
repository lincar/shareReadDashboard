...
define(
  ...
  function (DomParser, Node, Schema, Serializer, Tools, Settings, Utils) {
    ...
    var filterWordContent = function (editor, content) {
      ...
      // Add style/class attribute to all element rules since the account might have removed them from
...
/**
 * Tries to be smart depending on what the account pastes if it looks like an url
